...
FactoryGirl.create(:user, first_name: "John", last_name: "Lennon", email: "owner@myfirstshift.com", username: "admin", role: "owner", active: "true", password: "Password1", password_confirmation: "Password1", organization_id: 1, subdomain: organization_2.subdomain)
